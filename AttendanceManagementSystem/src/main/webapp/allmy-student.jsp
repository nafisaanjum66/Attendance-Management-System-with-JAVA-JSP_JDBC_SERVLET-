...
<c:if test="${fn:contains(msg, '1')}">
    ...
    <div class="container col-md-12">
        <center>
            ...
            <h2>Record of All Student</h2>
            <hr>
                <%--<h3>Record For <%= session.getAttribute("todaydate")%></h3>--%>
        </center>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <form action="searchallmystudent" method="get">
                            <input type="text" class="form-control" name="searchAllMyStudent"
                    ...
                    <div class="col-md-4">
                        <div class="container text-left">
                            ...
                            <form action="generatereportofallmystudent" method="get">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <input type="submit" class="form-control" name="generateAllMyStudent"
...
<c:if test="${fn:contains(message, 'success')}">
            <c:forEach var="person" items="${listPerson}">--%>
                    ...
                    <c:forEach var="student" items='<%= request.getAttribute("listMyStudent")%>'>

                        <tr>
                            <td><c:out value="${student.id}"/></td>
                            <td><c:out value="${student.todaydate}"/></td>
